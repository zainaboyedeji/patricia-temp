...
const activities: Activity[] = [
  {
    icon: (
      <Image src="/netflix.svg" alt="Netflix" width={20} height={20} />
    ),
    name: "Netflix",
    date: "Just now",
    amount: "$377.23",
  ...
  {
    icon: (
      <Image src="/nike.svg" alt="Nike" width={20} height={20} />
    ),
    name: "Nike",
    date: "Today",
    amount: "$237,737.55",
  ...
  {
    icon: (
      <Image src="/starbucks.svg" alt="Starbucks" width={20} height={20} />
    ),
    name: "Starbucks",
    date: "Yesterday",
  ...
  {
    icon: (
      <Image src="/amazon.svg" alt="Amazon" width={20} height={20} />
    ),
    name: "Amazon",
    date: "June 17",
    amount: "$599",
