...
const CardDetails: FC = () => {
  return (
    <div className="bg-[#F9FAFC] rounded-lg p-2 lg:p-6 w-full mx-auto mt-5 flex flex-col sm:flex-row">
      <div className="flex flex-col space-y-5 w-full sm:w-[80%]">
        ...
        <div className="flex space-x-4 items-center">
          <p className="text-[#9DA8B6] text-left w-[150px] sm:w-[200px]">Name:</p>
          <p className="text-patriciaGrey font-medium text-left">Netflix Card</p>
        </div>

        <div className="flex space-x-4 items-center">
          <p className="text-gray-400 text-left w-[150px] sm:w-[200px]">Card Status:</p>
          <p className="text-gray-800 font-medium text-left">Active</p>
        </div>

        <div className="flex space-x-4 items-center">
          <p className="text-gray-400 text-left w-[150px] sm:w-[200px]">Billing Address:</p>
        ...
        <div className="flex space-x-4 items-center">
          <p className="text-gray-400 text-left w-[150px] sm:w-[200px]">Date Created:</p>
