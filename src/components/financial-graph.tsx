  ...
  return (
    <div className="bg-[url('../../public/graph-bg.svg')] bg-cover bg-patriciaGreen text-white p-6 rounded-[1.5rem] shadow-md max-w-4xl mx-auto mt-5">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center">
        <div className="mr-6">
          <h2 className="text-patriciaTextGreen text-sm mb-3 font-semibold">Total Balance</h2>
          <p className="text-4xl font-bold">₦89,153,001.73</p>
          <p className="text-sm text-gray-300 mt-2 font-semibold">Book Balance: ₦450,000.093</p>
        </div>
